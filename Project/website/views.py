    ...
    if request.method == "POST":
        ...
        if len(query) < 1:
            ...
            if data_row_list != 0:
                ...
                if file_format == "CSV":
                    if os.path.exists(f"C:/Users/gf63/Desktop/Project/website/static/scraped-data/"
                        ...
                        with open(f"C:/Users/gf63/Desktop/Project/website/static/scraped-data/"
                                  f"{current_user.id}-{current_user.first_name}-"
                    ...
                    if os.path.exists(f"C:/Users/gf63/Desktop/Project/website/static/scraped-data/"
                        ...
                        data_frame.to_excel(f"C:/Users/gf63/Desktop/Project/website/static/scraped-data/"
                                            f"{current_user.id}-{current_user.first_name}-"
